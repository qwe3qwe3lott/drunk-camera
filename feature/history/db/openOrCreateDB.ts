...
export async function openOrCreateDB() {
    ...
    db.transaction((transaction) => {
        transaction.executeSql('CREATE TABLE  history ("id" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, "height" INTEGER NOT NULL, "width" INTEGER NOT NULL, "uri" TEXT NOT NULL, "angle" INTEGER NOT NULL, "dateTime" TEXT NOT NULL)');
    }, console.log);
